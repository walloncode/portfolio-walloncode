...
/**
 * FloatingLines — animated flowing-lines WebGL background (React Bits).
 * Ported to TypeScript for this codebase: container styled with Tailwind
 * instead of a separate CSS file, otherwise the original shader/logic.
 */
