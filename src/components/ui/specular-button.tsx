...
export function SpecularButton({
  ...
  return (
    <button
      ...
      onClick={onClick}
      className={cn(
        "relative m-0 inline-flex items-center justify-center border-none font-sans font-medium leading-none tracking-[0.01em]",
        "cursor-pointer outline-none transition-transform duration-150 ease-out",
